...
make_test_rtt_fair_var_mixed() {
local test_name="rtt_fair_var_mixed"
...
flent --input="$test_filename" --plot=bar_fairness --bounds-x="$length" --figure-width="$plot_width" --figure-height="$plot_height" --output="$data_dir/"bar_fairness.png
